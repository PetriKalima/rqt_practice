...
"""autogenerated by genpy from panda_pbd/MoveToContactActionResult.msg. Do not edit."""
import sys
...
class MoveToContactActionResult(genpy.Message):
  _md5sum = "203e4218b4f8f2868c0e4b963912eb0d"
  _type = "panda_pbd/MoveToContactActionResult"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','panda_pbd/MoveToContactResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToContactActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = panda_pbd.msg.MoveToContactResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = panda_pbd.msg.MoveToContactResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.final_pose.pose.position.x, _x.result.final_pose.pose.position.y, _x.result.final_pose.pose.position.z, _x.result.final_pose.pose.orientation.x, _x.result.final_pose.pose.orientation.y, _x.result.final_pose.pose.orientation.z, _x.result.final_pose.pose.orientation.w, _x.result.contact_forces.x, _x.result.contact_forces.y, _x.result.contact_forces.z, _x.result.contact_torques.x, _x.result.contact_torques.y, _x.result.contact_torques.z,) = _get_struct_13d().unpack(str[start:end])
      return self

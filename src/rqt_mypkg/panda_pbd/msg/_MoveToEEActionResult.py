...
"""autogenerated by genpy from panda_pbd/MoveToEEActionResult.msg. Do not edit."""
import sys
...
class MoveToEEActionResult(genpy.Message):
  _md5sum = "e94f532b5e59003c41666dc2252b3d8f"
  _type = "panda_pbd/MoveToEEActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','panda_pbd/MoveToEEResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MoveToEEActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = panda_pbd.msg.MoveToEEResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = panda_pbd.msg.MoveToEEResult()
